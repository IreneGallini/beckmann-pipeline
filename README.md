...
The classical anti-periplanar dihedral rule gives **20/34 correct predictions (59%)** on the benchmark set. The wCNmax-minimum rule gives **25/34 (74%)** via NBO7 — this motivated both the DFT/NBO phase and, later, the PySCF work to make that rule available without a Gaussian/HPC dependency. See `CLAUDE.md` for the full writeup.
