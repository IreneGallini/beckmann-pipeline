...
role (aryl/alkyl) that neither of those parsers determines on its own. See
Notes.md for the full derivation and the worked mol_002_E example.
...
def get_substituent_map(mol: str, mol_dir: Path) -> dict:
    ...
    Derived fresh via RDKit aromaticity (beckmann.analysis.classical.get_oxime_atoms)
