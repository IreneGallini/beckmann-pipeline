...
intermediate) come from beckmann.dft.ts_products, which guarantees identical
...
def build_qst_gjf(
    ...
    beckmann.dft.ts_products, which builds every endpoint from a copy of the
...
def main() -> None:
    ...
    from beckmann.dft.descriptors import _load_mols
