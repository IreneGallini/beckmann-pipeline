...
beckmann_nbo/recovery.py): for each in-scope molecule, classify its
...
Usage:
  python scripts/auto_recover.py                # all molecules
  python scripts/auto_recover.py --mol 020       # just mol_020_E
  python scripts/auto_recover.py --dry-run       # preview only
"""
import argparse

from beckmann_nbo.config import DATA_OUTPUT
from beckmann_nbo.hpc import load_config, mol_dirs, require_config
