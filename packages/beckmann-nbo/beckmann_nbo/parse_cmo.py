...
c_aryl/c_alkyl come from beckmann_nbo.descriptors.get_substituent_map() (fresh
...
from beckmann_nbo.parse_nbo import STAGES, log_terminated_normally, r_no_before
...
def is_bond_between(label: str, a: int, b: int) -> bool:
    ...
    beckmann_nbo.parse_cmo.build_cn_crossing_report(), scripts/
