"""
Baseline benchmark: does the classical anti-periplanar rule predict Beckmann
outcomes across the full 34-molecule benchmark set? get_oxime_atoms()/
predict()/ANTI_THRESH themselves moved to beckmann_core.classical (used live
by both products, not just this one-off benchmark script) -- this file has
only the benchmark-CSV-driving harness around them.
...
from beckmann_core.classical import get_oxime_atoms, predict
